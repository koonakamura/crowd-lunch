    ...
    return (
      ...
      >
        <div className="text-center">
          <h1 className="text-6xl font-bold text-black tracking-wide font-lato">
            CROWD LUNCH
          </h1>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-16 grid grid-cols-1 gap-6">
        {weeklyMenusData?.days && Object.keys(weeklyMenusData.days).sort().map((dateKey) => {
          ...
          return (
            <section 
              ...
              style={{
                backgroundImage: `url(${getBackgroundImage(dateKey, dayMenus)})`,
            ...
            >
              ...
              <div className="px-3 md:px-4 pb-8 flex flex-col gap-4">
                {dayMenus.length > 0 ? (
                  dayMenus.map((menu) => (
                    <button
                      key={menu.id}
